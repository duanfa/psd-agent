...
ALTER TABLE brand_rules
  ADD COLUMN IF NOT EXISTS markdown LONGTEXT NULL,
  ADD COLUMN IF NOT EXISTS training_prompt LONGTEXT NULL,
  ADD COLUMN IF NOT EXISTS source_asset_ids JSON NULL,
  ADD COLUMN IF NOT EXISTS website_urls JSON NULL,
  ADD COLUMN IF NOT EXISTS base_version VARCHAR(64) NULL;
